...
} from "./chunk-VPLHZB6C.js";
import {
  g
} from "./chunk-LXDCT5BB.js";
import "./chunk-PZ5AY32C.js";

// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/common/unicode.js
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/common/error-codes.js
var ERR;
(function(ERR2) {
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/tokenizer/preprocessor.js
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/common/token.js
var TokenType;
(function(TokenType2) {
...
// ../immersive-web-sdk/node_modules/.pnpm/entities@6.0.1/node_modules/entities/dist/esm/generated/decode-data-html.js
...
// ../immersive-web-sdk/node_modules/.pnpm/entities@6.0.1/node_modules/entities/dist/esm/generated/decode-data-xml.js
var xmlDecodeTree = new Uint16Array(
  // prettier-ignore
  "Ȁaglq	\x1Bɭ\0\0p;䀦os;䀧t;䀾t;䀼uot;䀢".split("").map((c) => c.charCodeAt(0))
);

// ../immersive-web-sdk/node_modules/.pnpm/entities@6.0.1/node_modules/entities/dist/esm/decode-codepoint.js
var _a;
...
// ../immersive-web-sdk/node_modules/.pnpm/entities@6.0.1/node_modules/entities/dist/esm/decode.js
var CharCodes;
(function(CharCodes2) {
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/common/html.js
var NS;
(function(NS2) {
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/tokenizer/index.js
var State;
(function(State2) {
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/parser/open-element-stack.js
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/parser/formatting-element-list.js
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/tree-adapters/default.js
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/common/doctype.js
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/common/foreign-content.js
var MIME_TYPES = {
  TEXT_HTML: "text/html",
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/parser/index.js
...
// ../immersive-web-sdk/node_modules/.pnpm/entities@6.0.1/node_modules/entities/dist/esm/escape.js
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/serializer/index.js
...
// ../immersive-web-sdk/node_modules/.pnpm/parse5@7.3.0/node_modules/parse5/dist/index.js
function parse(html, options) {
  return Parser.parse(html, options);
}

// ../immersive-web-sdk/node_modules/.pnpm/inline-style-parser@0.2.7/node_modules/inline-style-parser/esm/index.mjs
var COMMENT_REGEX = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//g;
var NEWLINE_REGEX = /\n/g;
...
// ../immersive-web-sdk/node_modules/.pnpm/@pmndrs+uikitml@0.1.12_super-three@0.181.0/node_modules/@pmndrs/uikitml/dist/parser/index.js
var classRegex = /\.([a-zA-Z0-9_-]+)(?::([a-zA-Z0-9_-]+))?\s*{([^}]*)}/g;
var idRegex = /#([a-zA-Z0-9_-]+)(?::([a-zA-Z0-9_-]+))?\s*{([^}]*)}/g;
function parse2(text, config) {
  const document = parse(text, { sourceCodeLocationInfo: true });
  const ranges = {};
  let nextId = 1;
  const annotateElements = (node) => {
    if (node.nodeName !== "#text" && node.nodeName !== "#comment" && node.sourceCodeLocation && node.nodeName !== "html" && node.nodeName !== "head" && node.nodeName !== "body" && node.nodeName !== "style" && node.nodeName !== "#document" && node.nodeName !== "script") {
...
function processInlineStyles(document, target) {
  const traverseElements = (element) => {
    if (element.nodeName === "style" && element.childNodes) {
      const textContent = element.childNodes.filter((child) => child.nodeName === "#text").map((child) => child.value || "").join("");
...
function extractCssRanges(cssText, styleLocation, ranges) {
  ...
  const classRegex2 = /\.([a-zA-Z_][\w-]*)\s*{/g;
  let match;
  while ((match = classRegex2.exec(cssText)) !== null) {
  ...
  while ((match = idRuleRegex.exec(cssText)) !== null) {
    ...
    ranges[idClassName] = {
      start: { line: startLine, column: startCol },
      end: { line: startLine, column: startCol + idName.length + 1 }
      // +1 for the # symbol
    };
  }
}
function calculatePosition(lines, index2) {
  let charCount = 0;
  for (let i = 0; i < lines.length; i++) {
    const lineLength = lines[i]?.length ?? 0;
    if (charCount + lineLength >= index2) {
      return { line: i, col: index2 - charCount };
    }
...
function toUikitElementJson(element, config) {
  ...
  const children = (element.childNodes || []).map((node) => toUikitElementJson(node, config)).filter((elementJson) => elementJson != null);
...
var panelProperties = /* @__PURE__ */ new Set([
  "borderRadius",
  "borderTopLeftRadius",
...
function parseInlineCss(styleString) {
  const parsedStyle = index(styleString);
  const style = {};
...
function parsePanelPropertyValue(propertyName, value) {
  ...
  if (value.match(/^-?\d+(?:\.\d+)?(rem|em|pt|vh|vw|vmin|vmax|%)$/)) {
    console.warn(`Property "${propertyName}" with value "${value}" may not be supported. Border radius properties only support pixel values (use "10px" or "10").`);
  }
  return value;
}
var yogaPropertyRenamings = {
  rowGap: "gapRow",
  columnGap: "gapColumn",
...
// ../immersive-web-sdk/node_modules/.pnpm/@pmndrs+uikitml@0.1.12_super-three@0.181.0/node_modules/@pmndrs/uikitml/dist/generator/index.js
...
function generateProperties(properties) {
  return Object.entries(properties).map(([key, value]) => {
    ...
    if (key === "class" && typeof value === "string") {
      const filteredClasses = value.split(" ").filter((className) => !className.startsWith("__id__")).join(" ").trim();
      if (!filteredClasses) {
        return void 0;
      }
...
function generateClassStyles(classes) {
  const styleRules = [];
...
function generate(json, classes) {
...
// ../immersive-web-sdk/node_modules/.pnpm/@pmndrs+uikitml@0.1.12_super-three@0.181.0/node_modules/@pmndrs/uikitml/dist/interpreter/html.js
var htmlKit = {
  ...
  textarea: class Textarea2 extends Input {
    constructor(inputProperties, initialClasses, config) {
      super(inputProperties, initialClasses, {
        ...config,
...
// ../immersive-web-sdk/node_modules/.pnpm/@pmndrs+uikitml@0.1.12_super-three@0.181.0/node_modules/@pmndrs/uikitml/dist/interpreter/index.js
...
function interpretElement(json, kit) {
  ...
  if (typeof json === "string") {
    const text = new Text({
      text: g(() => (text.parentContainer.value?.properties.value).text ?? json),
      alignSelf: "stretch",
      flexGrow: 1
    });
    return text;
...
function createCustomElement(json, properties, kit) {
  ...
  const CustomComponent = kit == null ? void 0 : kit.find(([name]) => name.toLowerCase() === componentName)?.[1];
  if (CustomComponent) {
...
function getElementDescription(json) {
  if (typeof json === "string") {
...
// ../immersive-web-sdk/node_modules/.pnpm/@pmndrs+uikitml@0.1.12_super-three@0.181.0/node_modules/@pmndrs/uikitml/dist/index.js
var conditionals = ["hover", "active", "focus", "sm", "md", "lg", "xl", "2xl"];
export {
  conditionals,
  generate,
...
//# sourceMappingURL=@pmndrs_uikitml.js.map
